...
iter =0; 
incre =abs((1/2*yb1)+ypb1-beta); %criterio que debe satisfacer t <-----

while incre >tol && iter < maxiter
t=t1 -((t1 -t0)*((1/2*yb1)+ypb1-beta))./(yb1-ypb1-yb0+ypb0); %expresion mñetodo secante <---- (yb1-ypb1-beta-yb0+ypb0+beta))

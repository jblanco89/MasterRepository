...
function plot_result(x, u, integral_method, t_opt_method)
    ...
    grid on;
    title(['Curva óptima ' integral_method '  con  ' num2str(length(x) - 1) ' puntos y t óptimo con  ' t_opt_method ]); 
    xlabel('x');
    ylabel('u(x)');
